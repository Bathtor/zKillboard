...
// CorpKB settings
$boardCorpId = "98198081";       // Corp ID for corp-centric zKB
$boardDefaultSubdomain = "kb";   // Default subdomain if hit with no/unknown subdomain. Remember, you have to create that subdomain yourself.
